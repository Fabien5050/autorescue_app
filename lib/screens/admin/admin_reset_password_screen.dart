...
/// Admin-portal counterpart to [ResetPasswordScreen] — same backend call
/// ([AuthApi.resetPassword]), just returns to [AdminLoginScreen] instead of
/// the regular one.
...
class _AdminResetPasswordScreenState extends State<AdminResetPasswordScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await AuthApi.resetPassword(token: _code, newPassword: _passwordController.text);
      if (!mounted) return;
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const Text(
                      'Enter the reset code from your email along with your '
                      'new password.',
